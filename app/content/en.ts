...
export const en: Dictionary = {
  ...
  home: {
    ...
    vote: {
      ...
      copyLabel: "Copy link",
      copiedLabel: "Copied",
      note: "The vote counter is local to your browser (demo). Support links go to the developer’s channels to signal demand for finishing the platform.",
    },
    contact: {
      eyebrow: "Contact",
